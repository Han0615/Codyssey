...
### 2.2 개발 도구 선정 — PyCharm

Python 전용 IDE인 **PyCharm**을 선택하였다. 강력한 코드 자동완성, 내장 디버거, 직관적인 실행 환경을 제공하여 빠르고 정확한 개발이 가능하다. VS Code 대비 Python에 최적화된 환경을 제공하며, Jupyter Notebook보다 스크립트 파일 관리에 적합하다.
